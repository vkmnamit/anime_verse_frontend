        ...
        <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-5 duration-700">
            ...
            <div className="flex items-center justify-between mb-8 pl-4 border-l-2 border-[#e63030]">
                <div className="flex flex-col gap-1">
                    <h2 className="text-2xl font-black uppercase tracking-[0.2em] text-white">Following</h2>
                    <p className="text-white/30 text-xs font-black uppercase tracking-widest">Tracking {followingList.length} signals in the Verse</p>
                </div>
