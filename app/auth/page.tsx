        ...
        <div className="min-h-screen bg-[#0b0b0f] flex overflow-hidden font-sans selection:bg-[#e63030]/30 selection:text-white">
            ...
            <div className="hidden lg:flex w-[50%] relative overflow-hidden group border-r border-white/5">
                <Image
                    ...
                    alt="Anime Art"
                    fill
                    className="object-cover transition-transform duration-[20000ms] ease-out group-hover:scale-110 opacity-80"
                    priority
                />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-7">
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="group relative">
                                        ...
                                        <button
                                            ...
                                            className="absolute right-8 top-1/2 -translate-y-1/2 text-white/10 hover:text-white/40 transition-colors"
                                        >
                                ...
                                <div className="grid grid-cols-2 gap-5">
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-4 bg-white/[0.02] border border-white/[0.06] hover:bg-white/[0.05] hover:border-white/10 rounded-2xl py-4.5 transition-all group active:scale-95"
                                    >
