                    ...
                    <div className="relative w-[223px] h-[64px] flex items-center justify-center rounded-[50px] border border-white/10 bg-white/[0.02]">
                        ...
                        <div className="flex items-center justify-center gap-5">
                            <button
                                ...
                                className="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:scale-110 transition-transform disabled:opacity-60 disabled:cursor-not-allowed"
                            >
